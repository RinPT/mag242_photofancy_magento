...
namespace Customweb\DatatransCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\DatatransCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\DatatransCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\DatatransCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('datatranscw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('datatranscw/customer/aliases', ['_current' => true]);
    }
