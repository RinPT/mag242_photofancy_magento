...
namespace Customweb\DatatransCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('datatranscw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('datatranscw_transaction');
	}
	...
	{
		return $this->getUrl('datatranscw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('datatranscw/transaction/');
	}
}