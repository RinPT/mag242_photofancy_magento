...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_DatatransCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('datatranscw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('datatranscw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('datatranscw/externalCheckout/registerPost', ['_secure' => true]);
	}
