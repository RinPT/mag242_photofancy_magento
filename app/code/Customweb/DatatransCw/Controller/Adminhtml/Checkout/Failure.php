...
class Failure extends \Customweb\DatatransCw\Controller\Adminhtml\Checkout
{
	public function execute()
	{
		...
		if (empty($sameSiteFix)) {
			...
			return $this->resultRedirectFactory->create()->setPath('datatranscw/checkout/failure', [
