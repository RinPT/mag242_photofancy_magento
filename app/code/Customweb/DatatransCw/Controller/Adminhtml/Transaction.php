...
namespace Customweb\DatatransCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_DatatransCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Datatrans', 'Datatrans');
		$resultPage->addBreadcrumb(__('Datatrans Transactions'), __('Datatrans Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\DatatransCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('datatranscw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_DatatransCw::transactions');
	}
}