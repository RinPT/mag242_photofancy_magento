...
class Iframe extends \Customweb\DatatransCw\Controller\Checkout
{
	public function execute()
	{
		try {
			$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
			/* @var $authorizationMethodAdapter \Customweb\DatatransCw\Model\Authorization\Method\Iframe */
			...
			$resultPage->getLayout()
				->getBlock('customweb_datatranscwcheckout_iframe')
