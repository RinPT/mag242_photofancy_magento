...
namespace Customweb\DatatransCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\DatatransCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	...
	/**
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\Context $context
	 * @return \Magento\Sales\Model\Order
	 */
	public function saveOrder(\Customweb\DatatransCw\Model\ExternalCheckout\Context $context)
	{
		...
		switch ($context->getRegisterMethod()) {
			case \Customweb\DatatransCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\DatatransCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\DatatransCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\DatatransCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\DatatransCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\DatatransCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
