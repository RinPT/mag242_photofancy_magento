...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'datatranscw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_DatatransCw::css/datatranscw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'datatranscw.main.content', 'content')->setText($content);
	}
