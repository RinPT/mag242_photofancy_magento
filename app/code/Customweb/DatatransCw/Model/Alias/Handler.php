...
namespace Customweb\DatatransCw\Model\Alias;
...
class Handler
{
	 ...
	 */
	public function getAliasTransactions(\Customweb\DatatransCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\DatatransCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\DatatransCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function deactivateAlias(\Customweb\DatatransCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
