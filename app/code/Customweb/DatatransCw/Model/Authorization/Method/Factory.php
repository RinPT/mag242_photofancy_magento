...
class Factory
{
     ...
     */
    public function create(\Customweb\DatatransCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\DatatransCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\DatatransCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\DatatransCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\DatatransCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\DatatransCw\Model\Authorization\Method\Context\Factory
     */
