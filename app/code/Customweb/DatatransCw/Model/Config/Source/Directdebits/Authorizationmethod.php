...
namespace Customweb\DatatransCw\Model\Config\Source\Directdebits;
...
class Authorizationmethod implements \Magento\Framework\Option\ArrayInterface
{
	...
	public function toOptionArray()
	{
		return [
			...
			['value' => 'HiddenAuthorization', 'label' => __('Hidden Authorization (Hidden Mode)')],
			['value' => 'AjaxAuthorization', 'label' => __('Ajax Authorization (Lightbox Mode)')],
			['value' => 'ServerAuthorization', 'label' => __('Server Authorization (XML Authorisation)')],
