...
namespace Customweb\DatatransCw\Model\ExternalCheckout;

/**
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\DatatransCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\DatatransCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\DatatransCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_datatranscw_external_checkout_context';
	...
	/**
	 * @var \Customweb\DatatransCw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\DatatransCw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\DatatransCw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\DatatransCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\DatatransCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\DatatransCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\DatatransCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\DatatransCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\DatatransCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\DatatransCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\DatatransCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\DatatransCw\Model\Payment\Method\AbstractMethod) {
			$data = [
