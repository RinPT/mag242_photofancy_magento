...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\DatatransCw\Model\ExternalCheckout\ContextFactory
	 */
	protected $_contextFactory;

	/**
	 * @var \Customweb\DatatransCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\DatatransCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\DatatransCw\Model\ExternalCheckout\ContextFactory $contextFactory
	 * @param \Customweb\DatatransCw\Helper\ExternalCheckout $helper
	 ...
	 * @param \Customweb\DatatransCw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\DatatransCw\Model\ExternalCheckout\ContextFactory $contextFactory,
			\Customweb\DatatransCw\Helper\ExternalCheckout $helper,
			...
			\Customweb\DatatransCw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\DatatransCw\Model\DependencyContainer $container
	 * @return \Customweb\DatatransCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\DatatransCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\DatatransCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\DatatransCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('datatranscw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\DatatransCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('datatranscw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\DatatransCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['datatranscw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_datatranscw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			/* @var $transaction \Customweb\DatatransCw\Model\Authorization\Transaction */
			$transaction = $this->_coreRegistry->registry('datatranscw_transaction');
