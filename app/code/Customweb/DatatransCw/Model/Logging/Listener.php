...
namespace Customweb\DatatransCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/datatranscw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('datatranscw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('datatranscw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
