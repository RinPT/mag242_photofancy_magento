...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	/**
	 *
	 * @var \Customweb\DatatransCw\Model\Configuration
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\DatatransCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\DatatransCw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\DatatransCw\Model\Configuration $configuration
	...
	public function __construct(
			...
			\Customweb\DatatransCw\Model\Configuration $configuration,
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('datatranscw_transaction');
		if ($transaction instanceof \Customweb\DatatransCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('datatranscw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_DatatransCw_License::run('5uo345adi1ee8nkh', $this, $arguments);
	}

	final public function call_esk87rhcufeouk1e() {
	 ...
	 * @return \Customweb\DatatransCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('datatranscw_authorization_transaction');
		if ($transaction instanceof \Customweb\DatatransCw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('datatranscw_invoice');
	...
	private function captureItems(\Customweb\DatatransCw\Model\Authorization\Transaction $transaction, $items = [])
	{
