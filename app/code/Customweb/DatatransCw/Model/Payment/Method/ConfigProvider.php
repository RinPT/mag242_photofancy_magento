...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    ...
    protected function getFailureMessage(AbstractMethod $method)
    {
    	if ($this->_checkoutSession->getQuote()->getPayment()->getMethod() == $method->getCode()) {
	    	$failureMessage = $this->_checkoutSession->getDatatransCwFailureMessage();
	    	if (!empty($failureMessage)) {
	    		$this->_checkoutSession->unsDatatransCwFailureMessage();
    ...
    protected function getImageUrl(AbstractMethod $method)
    {
    	try {
    		...
    		return $this->_assetRepo->getUrlWithParams('Customweb_DatatransCw/images/payment/method/' . $method->getPaymentMethodName() . '.png', $params);
    ...
    {
    	return new \Customweb\DatatransCw\Model\Renderer\CheckoutForm($method->getCode());
    }
