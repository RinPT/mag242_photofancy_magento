...
namespace Customweb\DatatransCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\DatatransCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\DatatransCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('datatranscw_form');
