...
namespace Customweb\DatatransCw\Model\ResourceModel;
		...
		*/
		if ($this->_isPkAutoIncrement) {
			...
			if (!empty($data)) {
				...
				if($rowAffected == 0) {
					throw new \Customweb\DatatransCw\Model\Exception\OptimisticLockingException(get_class($object), $object->getId());
				}
