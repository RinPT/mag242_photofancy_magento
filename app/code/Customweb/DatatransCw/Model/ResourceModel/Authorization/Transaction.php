...
namespace Customweb\DatatransCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\DatatransCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_datatranscw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\DatatransCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_datatranscw_transaction', 'entity_id');
    }
