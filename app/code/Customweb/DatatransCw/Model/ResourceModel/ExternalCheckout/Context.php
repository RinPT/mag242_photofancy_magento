...
namespace Customweb\DatatransCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\DatatransCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_datatranscw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_datatranscw_external_checkout_context', 'context_id');
    }
