...
class AuthorizationData implements \Customweb\DatatransCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\DatatransCw\Model\Service\AuthorizationFormField();
