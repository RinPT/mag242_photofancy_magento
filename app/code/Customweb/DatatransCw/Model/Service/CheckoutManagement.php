...
class CheckoutManagement implements \Customweb\DatatransCw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\DatatransCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\DatatransCw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\DatatransCw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\DatatransCw\Model\Exception\OptimisticLockingException
     */
    protected function buildPaymentForm($quoteId, $paymentMethod, $alias = null)
    {
	    	...
	    	for ($i = 0; $i < 10; $i++) {
	    		...
	    		catch (\Customweb\DatatransCw\Model\Exception\OptimisticLockingException $e) {
	    			// Try again.
	    			$lastException = $e;
	    		}
	    	}
    ...
    /**
     *
     * @param \Customweb\DatatransCw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\DatatransCw\Api\Data\AuthorizationFormFieldInterface $formValue */
