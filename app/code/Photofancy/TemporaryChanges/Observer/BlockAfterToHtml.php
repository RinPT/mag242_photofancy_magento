...
namespace Photofancy\TemporaryChanges\Observer;
    ...
    public function execute(Observer $observer)
    {
        ...
        try {
            $html = preg_replace_callback('/<script.*?>.*?<\/script>/is', function ($matches) use (&$inlineScripts) {
                ...
                //todo-marco Weltpixel Hotfix for Algolia Search Autocomplete
                if (false !== strpos($inlineScripts, '<script type="text/template"')) {
