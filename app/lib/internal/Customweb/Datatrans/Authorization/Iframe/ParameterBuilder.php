...
class Customweb_Datatrans_Authorization_Iframe_ParameterBuilder extends Customweb_Datatrans_Authorization_AbstractParameterBuilder {
...
// 		$parameters['useTouchUI'] = 'yes';
		$parameters['uppReturnTarget'] = '_top';
		$parameters['mode'] = 'inline';
		$parameters['theme'] = 'Inline';
		
		$settingsHandler = $this->getContainer()->getBean('Customweb_Payment_SettingHandler');
		$parameters['customTheme'] = $settingsHandler->getSettingValue('iframeTheme');
