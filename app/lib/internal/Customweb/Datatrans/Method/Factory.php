 ...
 * @Bean
 */
final class Customweb_Datatrans_Method_Factory extends Customweb_Payment_Authorization_Method_AbstractFactory {

	protected function getMethodPackages(){
		return array(
			'Customweb_Datatrans_Method' 
		);
	}

	/**
	 *
	 * @return Customweb_Datatrans_Method_DefaultMethod
	 */
