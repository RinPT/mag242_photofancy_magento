 ...
 * @Bean
 */
class Customweb_Datatrans_Authorization_PaymentPage_Adapter extends Customweb_Datatrans_Authorization_AbstractRedirectionAdapter implements 
	...
	public function getParameters(Customweb_Payment_Authorization_ITransaction $transaction, array $formData){
		$builder = new Customweb_Datatrans_Authorization_PaymentPage_ParameterBuilder($transaction, $this->getContainer(), $formData);
