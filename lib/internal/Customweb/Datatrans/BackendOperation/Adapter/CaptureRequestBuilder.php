 ...
 *
 */
class Customweb_Datatrans_BackendOperation_Adapter_CaptureRequestBuilder extends Customweb_Datatrans_AbstractMaintenanceParameterBuilder
{
	private $amount;
	...
	public function buildRequest() {
		...
		$xmlRequest->addParameter('reqtype', 'COA');
		$xmlRequest->addParameter('transtype', '05');
