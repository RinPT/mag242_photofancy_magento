 ...
 *
 */
abstract class Customweb_Datatrans_ExternalCheckout_AbstractCheckout extends Customweb_Payment_ExternalCheckout_AbstractCheckout{

	private $container;
	
	public function __construct(Customweb_DependencyInjection_IContainer $container) {
		parent::__construct(new Customweb_Datatrans_Container($container));
	}
